...
const indexTemplate = fsModule.readFileSync('dist/kkAjPublic/browser/index.html').toString();
...
// global['window']['MutationObserver'] = win.MutationObserver;
// Can add other options as per your application configuration

// The Express app is exported so that it can be used by serverless Functions.
export function app(): express.Express {
  const server = express();
  const distFolder = join(process.cwd(), 'dist/kkAjPublic/browser');
