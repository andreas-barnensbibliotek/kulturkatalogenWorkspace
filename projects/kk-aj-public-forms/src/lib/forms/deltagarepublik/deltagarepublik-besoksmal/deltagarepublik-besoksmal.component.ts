...
@Component({
  selector: 'aj-deltagarepublik-besoksmal',
  templateUrl: './deltagarepublik-besoksmal.component.html',
  styleUrls: ['./deltagarepublik-besoksmal.component.scss']
})
export class DeltagarepublikBesoksmalComponent implements OnInit {
  sliderval:any = "0"
