...
@Component({
  selector: 'aj-granska-fakta',
  templateUrl: './granska-fakta.component.html',
  styleUrls: ['./granska-fakta.component.scss']
})
export class GranskaFaktaComponent implements OnInit {
