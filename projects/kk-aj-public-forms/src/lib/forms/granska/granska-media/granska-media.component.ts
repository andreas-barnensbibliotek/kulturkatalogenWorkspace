...
@Component({
  selector: 'aj-granska-media',
  templateUrl: './granska-media.component.html',
  styleUrls: ['./granska-media.component.scss']
})
export class GranskaMediaComponent implements OnInit {
